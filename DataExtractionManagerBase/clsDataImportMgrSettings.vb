Public Class clsDataImportMgrSettings
    Implements IMgrParams

    'ini file reader
    Private m_IniFilePath As String = ""
    Private m_iniFileReader As PRISM.Files.IniFileReader
    ...
    Public Function LoadSettings() As Boolean
        m_iniFileReader = New PRISM.Files.IniFileReader(m_IniFilePath, False)
    ...
    Public Function GetParam(ByVal Section As String, ByVal Item As String) As String Implements IMgrParams.GetParam
        Return m_iniFileReader.GetIniValue(Section, Item)
    End Function
