...
#End Region
    ...
    Private Function RetrieveXmlFileContents(ByVal xmlFile As String) As String
        ...
        Catch Err As System.Exception
            m_logger.PostEntry("clsDataImportTask.PostTask(), Error reading xml file, " & Err.Message, ILogger.logMsgType.logError, True)
        End Try
    ...
    Private Function ImportDataTask(ByVal mp_xmlContents As String) As Boolean
        ...
        Try
            ...
            '
            mp_stored_proc = m_mgrParams.GetParam("DatabaseSettings", "storedprocedure")
